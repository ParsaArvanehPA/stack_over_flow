			...
			<div className='main'>
				<div className='main__feature'>
					...
					<span className='main__feature__description'>
						You will adapt to site easily and learn how to use it
						just as well
					</span>
				</div>
				...
				<div className='main__feature'>
					...
					<p className='main__feature__description'>
						Communicate with other users and ask them to help you
						solve your problems
					</p>
				</div>
				...
				<div className='main__feature'>
					...
					<p className='main__feature__description'>
						Every single feature in Stack Over Flow is completely
